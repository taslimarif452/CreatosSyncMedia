    ...
    <div id="contact-page" className="pt-32 pb-24 bg-[#080808]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-7 p-8 sm:p-12 rounded-3xl bg-[#101010] border border-[#262626]">
            {isSubmitted ? (
              <div className="py-12 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-3 bg-[#4F7CFF] hover:bg-[#3D6CE5] text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-all cursor-pointer shadow-lg shadow-[#4F7CFF]/20 flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-3 bg-[#141414] hover:bg-[#1C1C1C] border border-[#262626] text-xs font-bold text-[#F5F5F5] uppercase tracking-wider rounded-xl cursor-pointer"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  >
                    <option value="Brand Campaign Inquiry">Brand Campaign Inquiry (Hire Creators)</option>
                    <option value="Creator Representation">Creator Roster Application (I'm a Creator)</option>
                    <option value="Strategic Partnership">Agency Partnership / Press</option>
